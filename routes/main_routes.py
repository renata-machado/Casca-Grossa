...
async def post_cadastrar(
    ...
    usuario = Usuario(None, nome,sobrenome, telefone, senha_hash, None, perfil)
    UsuarioRepo.inserir(usuario)
    return RedirectResponse("/", status_code=status.HTTP_303_SEE_OTHER)

@router.post("/post_cadastrar_endereco")
async def post_cadastrar(
    endereco: str = Form(...),
    ...
    endereco = Endereco(endereco, complemento, cep,cidade,uf)
